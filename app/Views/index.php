...
<body>
  ...
  <header id="header" class="header-tops">
    <div class="container">
      ...
      <h1><a href="index.html">M. Fachrizal Muzakky</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>I'm a passionate <span>web developer</span> from Mojokerto</h2>
      ...
      <div class="social-links">
        ...
        <a href="https://web.facebook.com/profile.php?id=100010323720797" target="_blank" class="facebook"><i class="icofont-facebook"></i></a>
        <a href="https://www.instagram.com/zzz.zzzzzz.z/" target="_blank" class="instagram"><i class="icofont-instagram"></i></a>
        <a href="https://github.com/zakky-sy" target="_blank" class="google-plus"><i class="icofont-github"></i></a>
        <a href="https://www.linkedin.com/in/mochammad-fachrizal-muzakky-6b67801a7/" target="_blank" class="linkedin"><i class="icofont-linkedin"></i></a>
      </div>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="<?= base_url(); ?>/assets/img/me2.png" class="img-fluid" alt="">
        </div>
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 3 June 2001</li>
                <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> www.example.com</li>
                <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> +62 8554 6343 278</li>
                <li><i class="icofont-rounded-right"></i> <strong>City:</strong> Mojokerto, East Java</li>
              </ul>
            </div>
            <div class="col-lg-6">
              <ul>
                <li><i class="icofont-rounded-right"></i> <strong>Age:</strong> 20</li>
                <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> Associate's degree</li>
                <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> 191221007@mhs.stiki.ac.id</li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            ...
            <p>
            <ul>
              <li>05 Mojorejo, Pungging, MJK 61384</li>
              <li>+62 8554 6343 278</li>
              <li>191221007@mhs.stiki.ac.id</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>Associate's Degree of Information Management</h4>
            <h5>2019 - 2022</h5>
            <p><em>Sekolah Tinggi Informatika dan Komputer Indonesia, Sukun, MLG 65146</em></p>
            <p>Qui deserunt veniam. Et sed aliquam labore tempore sed quisquam iusto autem sit. Ea vero voluptatum qui ut dignissimos deleniti nerada porti sand markend</p>
          </div>
          <div class="resume-item">
            <h4>Diploma of Fine Arts &amp; Graphic Design</h4>
            <h5>2016 - 2019</h5>
            <p><em>SMK Negeri 1 Pungging, Pungging, MJK 61384</em></p>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            ...
            <h5>2023 - Present</h5>
            <p><em>Beon Intermedia, Lowokwaru, MLG 65145</em></p>
            <p>
            <ul>
              <li>Lead in the design, development, and implementation of the graphic, layout, and production communication materials.</li>
              <li>Delegate tasks to the 7 members of the design team and provide counsel on all aspects of the project. </li>
              <li>Supervise the assessment of all graphic materials in order to ensure quality and accuracy of the design of the Website.</li>
          ...
          <div class="resume-item">
            ...
            <h5>2022 - 2023</h5>
            <p><em>Pictalogi, Lowokwaru, MLG 65141</em></p>
            <p>
            <ul>
              <li>Developed numerous website and marketing programs (logos, brochures,infographics, presentations, and advertisements).</li>
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                ...
                <a href="<?= base_url('portfolio'); ?>" data-gall="portfolioDetailsGallery" data-vbtype="iframe" class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6 d-flex align-items-stretch">
          <div class="info-box">
            <i class="bx bx-map"></i>
            <h3>My Address</h3>
            <p>05 Mojorejo, Pungging, MJK 61384</p>
          </div>
        </div>
